    ...
    <div class="inner-wrapper">
        ...
        <div class="inner-sidebar">
            ...
            <div class="inner-sidebar-header justify-content-center">
              <a class="btn btn-primary" href="{{url('postanggota/create')}}" > + NEW DISCUSSION <a>
                <!-- <button class="btn btn-primary has-icon btn-block" type="button" data-toggle="modal" data-target="">
        ...
        <div class="inner-main">
            ...
            <!-- Forum List -->
            @foreach($list_post_anggota as $postanggota)
                <div class="card mb-2">
                    <div class="card-body p-2 p-sm-3">
                        <div class="media forum-item">
                            ...
                            <div class="media-body">
                                ...
                                <h6><a href="}" data-toggle="collapse" class="text-body">{{ $postanggota->title }}</a></h6>

                                <p class="text-secondary">
                                  {{ $postanggota->description }}
                                </p>

                                <p class="text-muted"><a href="javascript:void(0)">{{ Auth::user()->name }}</a> replied <span class="text-secondary font-weight-bold">13 minutes ago</span></p>
                            </div>
                            <div class="btn-group">
                              <a class="btn btn-success btn-sm" href="{{ url('/postanggota/'.$postanggota->id) }}"> View <a>
                              <a class="btn btn-warning btn-sm" href="{{ url('/postanggota/'.$postanggota->id.'/edit') }}"> Edit <a>
                                <form method="post" action="{{ url('/postanggota/'.$postanggota->id )}}">
